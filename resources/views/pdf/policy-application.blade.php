...
<body>
    ...
    <div class="period-info">
        ...
        <strong>From:</strong> {{ $pricing && $pricing->policy_start_date ? \Carbon\Carbon::parse($pricing->policy_start_date)->format('d-M-Y') : 'N/A' }}
        <strong>To:</strong> {{ $pricing && $pricing->policy_expiry_date ? \Carbon\Carbon::parse($pricing->policy_expiry_date)->format('d-M-Y') : 'N/A' }}<br>
    ...
    <div class="sub-section">
        ...
        <table>
            ...
            <tr>
                ...
                <td>{{ $primaryClinic ? $primaryClinic->address . ', ' . $primaryClinic->postcode . ', ' . $primaryClinic->city . ', ' . $primaryClinic->state : 'N/A' }}</td>
            </tr>
        </table>
    </div>
    ...
    <div class="sub-section">
        ...
        <table>
            ...
            <tr>
                <td class="label">Address:</td>
                <td>{{ $secondaryClinic->address }}, {{ $secondaryClinic->postcode }}, {{ $secondaryClinic->city }}, {{ $secondaryClinic->state }}</td>
            </tr>
        </table>
    </div>
    @endif
    ...
    <p style="font-size: 9px; margin: 5px 0;">I hereby authorise Great Eastern General Insurance (Malaysia) Berhad (GEGM) to charge one-off payment for the above insurance policy to my card as started below:</p>
    <table>
        <tr>
    ...
    <p style="font-size: 8px; margin-top: 10px;">I undertake that all information stated above is true and complete in all respects. I have read and understood the terms & conditions contained in this form and I hereby agreed that the company may process the manner as stated in GEGM's Easi-pay Service Form (A copy can be obtained upon request).</p>
    @endif
    ...
    <table>
        ...
        <tr>
            <td class="label">3.4 Do you have facilities for sterilisation of instruments in accordance with relevant guidelines/standards applying to your industry?</td>
    ...
    <table>
        <tr>
            <td class="label">4.1 Do you currently hold medical malpractice insurance? (If YES, please provide details.)</td>
    ...
    <table>
        <tr>
            <td class="label">4.2 Have you ever had any application for medical malpractice insurance refused, or had any medical malpractice insurance coverage rescinded or cancelled? (If YES, please provide details on a separate sheet, noting the Section number.)</td>
    ...
    <table>
        ...
        <tr>
            <td class="label">5.2 Are you aware of any errors, omissions, offences, circumstances or allegations which might result in a claim being made against you?</td>
            <td>{{ $claims && $claims->aware_of_errors ? 'Yes' : 'No' }}</td>
        </tr>
        <tr>
            <td class="label">5.3 Have you ever been the subject of disciplinary action or investigation by any authority or regulator or professional body?</td>
    ...
    <p style="font-size: 9px; margin: 10px 0;"><strong>If you had answered Yes to any of the questions in this section, please provide full details overleaf and the status of each claim, lawsuits, allegation or matter, including</strong></p>
    <table>
        <tr>
    ...
    <div class="declaration">
        ...
        <ol>
            <li>All the foregoing statement s and answer s in this pr oposa l form together with any other document s or questionnaires submitted in connection with the proposal form all statements made and answers given to the Company's medical examiner(s), are complete and accurate ("the Information") and I under stand that the Information given by me is relevant to the Company in deciding whether to accept my proposal or not and the rates and terms to be applied. The Company may terminate or void the policy or reduce the amount of my claim, or reduce or vary the terms of the policy contract, if there is any non-disclosure, misrepresentation, misstatement, inaccuracy or omission.</li>
            
            <li>I/We would like to receive updates on Company's products, services, promotions, charitable causes or other marketing information from relevant third parties of the Company.</li>
            
            <li>I/We have fully read and under stood all the contents of, and the warnings and advice contained in this proposal form.</li>
            
            <li>I/We have fully read and understood the Data Protection Notice above and I/we agree that the Company may process the personal sensitive information inline with the manner as set out in the Notice.</li>
            
            <li>I/We declare that any funds and/or assets I/we place with the Company, as well as any profits that they generate, comply with the tax laws of the country (ies) where I/we am/are resident(s), as well as the tax laws of the country(ies) of which I/we am/are citizen(s).</li>
            
            <li>In the event the Company becomes aware that I/we and/or any other named insured(s) am/are or have become a prohibited person, meaning a person/entity who is subject to any laws, regulations and/or sanctions administered by any governmental or regulatory authorities or any other relevant authority as are currently or may become in the future in force or on any relevant list issued by and as determined by any such authority(ies), that have the effect of prohibiting the Company from providing insurance coverage or otherwise offer ing any benefit s to me/us or any other named insured(s) under the policy, whichever applicable, I/we agree that the Company may suspend, terminate or void the policy or my/our insurance coverage under the policy, whichever applicable, with effect from the appropriate date or from inception, as appropriate and at the sole discretion of the Company, and shall not be required to transact any business with me/us in connection with the policy, including but not limited to, making or receiving any payments under the policy or proposal submitted or any cover note issued, whichever.</li>
        </ol>
        
        <p style="margin-top: 10px;">Further, in the event the Company becomes aware that any of the Life Assured, Trustee, Assignee, Beneficiary, Beneficial Owner and/or Nominee and/or Mortgagee/Financier named in or connected with the policy is or has become a prohibited person, I/we agree that the Company may suspend, terminate, or void the policy or my/our insurance coverage under the policy, whichever applicable with effect from the appropriate date or from inception, as appropriate and at the sole discretion of the Company, and shall not be required to transact any business in connection with the policy, including but not limited to, making or receiving any payments under the policy or proposal submitted or any cover note issued, whichever</p>
        
        <p style="margin-top: 10px;">Under any of the above circumstances, the Company shall not be deemed to provide cover and/or be liable to pay any claim or benefits under the policy or proposal submitted or any cover note issued, whichever applicable.</p>
    </div>
    ...
    <div class="signature-section">
        <table>
            <tr>
                <td style="width: 30%;"><strong>Date:</strong> {{ $policyApplication->submitted_at ? $policyApplication->submitted_at->format('d/M/Y') : now()->format('d/M/Y') }}</td>
                <td style="width: 70%; text-align: right;">
                    @if($policyApplication->signature_data)
                        <img src="{{ $policyApplication->signature_data }}" alt="Signature" style="max-height: 40px;">
                    @else
