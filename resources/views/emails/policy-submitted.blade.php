...
<body>
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="content">
                We are pleased to inform you that your application for <strong>Indemnity Insurance</strong> has been successfully submitted.
            </div>
            
            @if($policyApplication->reference_number)
            <div class="info-box">
                <p><strong>Reference Number:</strong> {{ $policyApplication->reference_number }}</p>
                <p><strong>Submitted Date:</strong> {{ $policyApplication->submitted_at->format('d M Y, h:i A') }}</p>
            </div>
            @endif
            
            <div class="content">
                Once the application has been approved, we will notify you to proceed with the payment.
            </div>
