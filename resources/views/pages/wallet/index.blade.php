...
@section('main_content')
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" class="form-control" id="add_amount" name="amount" step="0.01"
                                    min="0.01" required>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Deduct Amount Modal -->
    <div class="modal fade" id="deductAmountModal" tabindex="-1" aria-labelledby="deductAmountModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
