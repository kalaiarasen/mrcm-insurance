    ...
    <div class="container-fluid p-0">
        <div class="row g-0 min-vh-100">
            <div class="col-xl-7 d-none d-xl-block">
                <div class="bg-img-cover bg-center h-100 position-relative"
                    style="background-image: url('https://laravel.pixelstrap.com/cuba/assets/images/login/2.jpg'); min-height: 100vh;">
                </div>
            </div>
