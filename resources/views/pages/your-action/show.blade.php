...
@section('css')
    <style>
        ...
        .info-card {
            border-left: 4px solid var(--theme-default, #0d6efd);
        ...
        .section-title {
            color: var(--theme-default, #0d6efd);
            border-bottom: 2px solid var(--theme-default, #0d6efd);
            padding-bottom: 10px;
            margin-bottom: 20px;
            font-weight: 600;
        }
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="info-value">{{ $healthcare ? ucfirst(str_replace('_', ' ', $healthcare->professional_indemnity_type)) : 'N/A' }}</div>
                            </div>
                            <div class="col-md-3">
                                <div class="info-label">Employment Status</div>
                                <div class="info-value">{{ $healthcare ? ucfirst(str_replace('_', ' ', $healthcare->employment_status)) : 'N/A' }}</div>
                            </div>
                            <div class="col-md-3">
                                <div class="info-label">Specialty Area</div>
                                <div class="info-value">{{ $healthcare && $healthcare->specialty_area ? ucfirst(str_replace('_', ' ', $healthcare->specialty_area)) : 'N/A' }}</div>
                            </div>
                            <div class="col-md-3">
                                <div class="info-label">Cover Type</div>
                                <div class="info-value">{{ $healthcare && $healthcare->cover_type ? ucfirst(str_replace('_', ' ', $healthcare->cover_type)) : 'N/A' }}</div>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                ...
                                <div class="info-value">{{ $healthcare && $healthcare->service_type ? ucfirst(str_replace('_', ' ', $healthcare->service_type)) : 'N/A' }}</div>
                            </div>
                            <div class="col-md-4">
                                <div class="info-label">Practice Area</div>
                                <div class="info-value">{{ $healthcare && $healthcare->practice_area ? ucfirst(str_replace('_', ' ', $healthcare->practice_area)) : 'N/A' }}</div>
                            </div>
                            <div class="col-md-4">
                                <div class="info-label">Locum Practice Location</div>
                                <div class="info-value">{{ $healthcare && $healthcare->locum_practice_location ? ucfirst(str_replace('_', ' ', $healthcare->locum_practice_location)) : 'N/A' }}</div>
                            </div>
                        </div>
                    </div>
                </div>
